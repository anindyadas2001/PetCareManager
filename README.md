...
<table style="border: 5px solid black; border-radius: 8px; padding: 10px;">
  <tr>
    <td>
...
<br /> As per the [directory-map](https://github.com/anindyadas2001/PetCareManager/blob/fe3f1b1e70ca2974efb9233d89d99303f003798f/directory-map.txt) all files to be uploaded soon.
