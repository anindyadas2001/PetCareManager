...
⭐` The Project is yet under Dvelopment, most if it has been completed.` ` Reffer to the **Features & Technologies** for the progress  ` `The overview is provided for now `
        **Progress Bar**
        --------------
        [##################################################------] 72.22%
