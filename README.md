...
- <div style="background-color: yellow;">Further Developments are made in this repository, where the app is deploued into a seamlessly automated DevOps pipeline.</div>
